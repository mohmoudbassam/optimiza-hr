        ...
        <div class="d-flex flex-column-fluid">
            ...
            <div class="container">
                ...
                <div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
                    ...
                    <div class="alert-text">Report</div>
                </div>
                <!--end::Notice-->
                <!--begin::Card-->
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-3 col-xl-3">
                                    <div class="row align-items-center">
                                        <div class="col-lg-12 col-xl-12">
                                            <div class="form-group">
                                                <label for="exampleSelect1">Month
                                                    <span class="text-danger"></span></label>
                                ...
                                <div class="col-lg-3 col-xl-3">
                                    <div class="row align-items-center">
                                        <div class="col-lg-12 col-xl-12">
                                            <div class="form-group">
                                                <button type="button" @click.prevent="search('user')"
                                                        class="btn btn-primary mr-2 mt-6">Search
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row mb-7">
                            <div class="col-xl-4">
                                <div class="d-flex justify-content-sm-around flex-wrap">
                                    <Button :class="view!='user'?'p-button-outlined':''" @click="view='user'"
                                            label="User"
                                            outlined/>

                                    <Button :class="view!='companies'?'p-button-outlined':''" @click="search('companies')"
                                            label="Company" outlined/>
                                    <Button :class="view!='projects'?'p-button-outlined':''" @click="view='projects'"
                                            label="projects" outlined/>
