    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
                ...
                <div class="alert-text">The Companies</div>
            </div>
            <!--end::Notice-->
            <!--begin::Card-->
            <div class="card card-custom">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    ...
                    <div class="card-toolbar">
                        ...
                        <!--end::Dropdown-->
                        <!--begin::Button-->
                        <Link :href="route('companies.create')" class="btn btn-primary font-weight-bolder">
                            	<span class="svg-icon svg-icon-md">
...
<!--                            </div>-->
                    ...
                    <div
                        ...
                        <table class="datatable-table" style="display: block;">
                            ...
                            <tr v-for="company in companies.data" class="datatable-row" style="left: 0px;">

                                <td data-field="OrderID"  class="datatable-cell text-center"><span
                                    style="width: 123px;">{{ company.name }}</span></td>
                                <td data-field="Country" class="datatable-cell text-center"><span
                                    style="width: 123px;">{{ company.email }}</span></td>
                        ...
                        <div class="datatable-pager datatable-paging-loaded">
                            <ul class="datatable-pager-nav my-2 mb-sm-0">
                                ...
                                <Pagination :links="companies.links" class="datatable-pager-link datatable-pager-link-number datatable-pager-link-active"></Pagination>
...
export default {
    ...
    methods:{
        editCompany(company){
            this.$inertia.visit(route('companies.edit',{'id':company.id}))
        },
