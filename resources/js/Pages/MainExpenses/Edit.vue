        ...
        <div class="d-flex flex-column-fluid">
            ...
            <div class="container">
                <div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
                    ...
                    <div class="alert-text">Update  Expenses </div>
                </div>
                    ...
                    <form @submit.prevent="submit">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" v-model="expenses.description" class="form-control form-control-solid" rows="3"></textarea>
...
export default {
    ...
    methods: {
         ...
         submit ()  {
            ...
            form.post(route('main_expenses.update', {id: this.expenses.id}), {
                preserveScroll: true,
                onSuccess: () => {
                    createToast("Expenses Updated Successfully", {
                        type: "success",
                        position: "top-right",
                        timeout: 3000,
                    });
