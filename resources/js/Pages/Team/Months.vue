                            ...
                            <tr v-for="bill in bills.data">
                                <td class="pl-0 py-8">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{bill.year}}</span>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{bill.month}}</span>
                                </td>
                                <td>
