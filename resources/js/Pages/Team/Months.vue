                ...
                <div class="card card-custom">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                                ...
                                <tr class="text-uppercase">
                                    <th style="min-width: 150px" class="pl-7 text-center">
                                        <span class="text-dark-75">Year</span>
                                    </th>
                                    <th style="min-width: 150px " class="text-center">Month</th>
                                ...
                                <tr v-for="bill in bills.data">
                                    <td class="pl-0 py-8">
                                        <div class="text-center">
                                            ...
                                            <div>
                                                <span
                                                    class="text-dark-75 font-weight-bolder d-block font-size-lg ">{{ bill.year }}</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <span
                                            class="text-dark-75 font-weight-bolder d-block font-size-lg text-center">{{ bill.month }}</span>
                                    </td>
                                    <td data-field="Country" aria-label="Paraguay" class="text-center">
                                        <div class="dropdown dropdown-inline ">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                ...
                                                <ul class="navi flex-column navi-hover py-2">
                                                    ...
                                                    <li class="navi-item">
                                                        <Link :href="route('tasks.my_tasks',{bill:bill.id})"
                                                              class="navi-link">
                                                            <i class="la la-tasks p-1"></i>
                                                            <span class="navi-text">My Tasks</span>
                                                        </Link>
                                                    </li>
                                                    <li class="navi-item">
                                                        <Link :href="route('bills.show_bill_tasks',{bill:bill.id})"
                                                              class="navi-link">
																<span class="navi-icon">
																	<i class="la la-copy"></i>
																</span>
                                                    ...
                                                    <li class="navi-item">
                                                        <Link
                                                            :href="route('bills.add_expenses_to_bill_form',{bill_id:bill.id})"
                                                            class="navi-link">
																<span class="navi-icon">
																	<i class="la la-copy"></i>
																</span>
                        ...
                        <div class="datatable-pager datatable-paging-loaded">
                            <ul class="datatable-pager-nav my-2 mb-sm-0 d-flex">
...
export default {
    name: "Months",
    components: {Layout, Pagination, Link},
    props: {
        bills: []
    }
}
