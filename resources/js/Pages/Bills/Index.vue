                                ...
                                <tr v-for="bill in bills.data" class="datatable-row" style="left: 0px;">
                                    ...
                                    'title':'Expenses',
                                     'bill':bill
                                      ...
                                      url:route('bills.change_bill_status',{bill:bill.id}),
                                        'title':bill.is_closed?'Open Bill':'Close Bill',
                                        'bill':bill
                                  },]" @openClose="openClose"></BtnVutify>
                                    </td>
                            ...
                            <div class="datatable-pager datatable-paging-loaded">
                                <ul class="datatable-pager-nav my-2 mb-sm-0">
                                    <Pagination :links="bills.links"
                                                class="datatable-pager-link datatable-pager-link-number datatable-pager-link-active"></Pagination>
                                </ul>
